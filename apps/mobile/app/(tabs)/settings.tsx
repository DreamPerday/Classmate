...
import{deleteLocalAsrModel,downloadLocalAsrModel,getSystemCaptureStatus,onModelProgress,requestOverlayPermission,type ModelProgress}from"@/services/system-capture";
...
export default function SettingsScreen(){
  ...
  const error=save.error||refresh.error||refreshEmbedding.error||test.error||reindex.error||modelDownload.error||modelDelete.error||overlay.error;
